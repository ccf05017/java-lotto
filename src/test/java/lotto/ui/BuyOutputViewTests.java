...
class BuyOutputViewTests {
    ...
    @BeforeEach
    public void setup() {
        LottoTicket fakeLottoTicket1 = LottoGenerator.createByManualNumbers(Arrays.asList(1, 2, 3, 4, 5, 6));
        LottoTicket fakeLottoTicket2 = LottoGenerator.createByManualNumbers(Arrays.asList(7, 8, 9, 10, 11, 12));
